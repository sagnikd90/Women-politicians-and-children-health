...
df_panel$election_year[df_panel$state_name=="andhra pradesh" & df_panel$cohort>=1990 & df_panel$cohort<1994]<- 1989
df_panel$election_year[df_panel$state_name=="andhra pradesh" & df_panel$cohort>=1995 & df_panel$cohort<1999]<- 1994
df_panel$election_year[df_panel$state_name=="andhra pradesh" & df_panel$cohort>=2000 & df_panel$cohort<2004]<- 1999
df_panel$election_year[df_panel$state_name=="andhra pradesh" & df_panel$cohort>=2005 & df_panel$cohort<2009]<- 2004
df_panel$election_year[df_panel$state_name=="andhra pradesh" & df_panel$cohort>=2010 & df_panel$cohort<2014]<- 2009
df_panel$election_year[df_panel$state_name=="andhra pradesh" & df_panel$cohort>2014]<- 2014

############### Arunachal Pradesh ###################

df_panel$election_year[df_panel$state_name=="arunachal pradesh" & df_panel$cohort>=1991 & df_panel$cohort<1995]<- 1990
df_panel$election_year[df_panel$state_name=="arunachal pradesh" & df_panel$cohort>=1996 & df_panel$cohort<1999]<- 1995
df_panel$election_year[df_panel$state_name=="arunachal pradesh" & df_panel$cohort>=2000 & df_panel$cohort<2004]<- 1999
df_panel$election_year[df_panel$state_name=="arunachal pradesh" & df_panel$cohort>=2005 & df_panel$cohort<2009]<- 2004
df_panel$election_year[df_panel$state_name=="arunachal pradesh" & df_panel$cohort>=2010 & df_panel$cohort<2014]<- 2009
df_panel$election_year[df_panel$state_name=="arunachal pradesh" & df_panel$cohort>2014]<- 2014

##################### Assam ###########################

df_panel$election_year[df_panel$state_name=="assam" & df_panel$cohort>=1992 & df_panel$cohort<1996]<- 1991
df_panel$election_year[df_panel$state_name=="assam" & df_panel$cohort>=1997 & df_panel$cohort<2001]<- 1996
df_panel$election_year[df_panel$state_name=="assam" & df_panel$cohort>=2002 & df_panel$cohort<2006]<- 2001
df_panel$election_year[df_panel$state_name=="assam" & df_panel$cohort>=2007 & df_panel$cohort<2011]<- 2006
df_panel$election_year[df_panel$state_name=="assam" & df_panel$cohort>=2012 & df_panel$cohort<2016]<- 2011

###################### Bihar ###################

df_panel$election_year[df_panel$state_name=="bihar" & df_panel$cohort>=1991 & df_panel$cohort<1995]<- 1990
df_panel$election_year[df_panel$state_name=="bihar" & df_panel$cohort>=1996 & df_panel$cohort<2000]<- 1995
df_panel$election_year[df_panel$state_name=="bihar" & df_panel$cohort>=2001 & df_panel$cohort<2005]<- 2000
df_panel$election_year[df_panel$state_name=="bihar" & df_panel$cohort>=2006 & df_panel$cohort<2010]<- 2005
df_panel$election_year[df_panel$state_name=="bihar" & df_panel$cohort>=2011 & df_panel$cohort<2015]<- 2010
df_panel$election_year[df_panel$state_name=="bihar" & df_panel$cohort>2015]<- 2015

##################### Chhattisgarh ##################################

df_panel$election_year[df_panel$state_name=="chhattisgarh" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="chhattisgarh" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="chhattisgarh" & df_panel$cohort>2013]<- 2013


###################### Delhi #########################

df_panel$election_year[df_panel$state_name=="delhi" & df_panel$cohort>=1994 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="delhi" & df_panel$cohort>=1999 & df_panel$cohort<2003]<- 1998
df_panel$election_year[df_panel$state_name=="delhi" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="delhi" & df_panel$cohort>=2009 & df_panel$cohort<2015]<- 2008
df_panel$election_year[df_panel$state_name=="delhi" & df_panel$cohort>2015]<- 2015

###################### Goa ########################

df_panel$election_year[df_panel$state_name=="goa" & df_panel$cohort>=1990 & df_panel$cohort<1994]<- 1989
df_panel$election_year[df_panel$state_name=="goa" & df_panel$cohort>=1995 & df_panel$cohort<1999]<- 1994
df_panel$election_year[df_panel$state_name=="goa" & df_panel$cohort>=2000 & df_panel$cohort<2002]<- 1999
df_panel$election_year[df_panel$state_name=="goa" & df_panel$cohort>=2003 & df_panel$cohort<2007]<- 2002
df_panel$election_year[df_panel$state_name=="goa" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="goa" & df_panel$cohort>=2013]<- 2012

##################### Gujarat #########################

df_panel$election_year[df_panel$state_name=="gujarat" & df_panel$cohort>=1991 & df_panel$cohort<1995]<- 1990
df_panel$election_year[df_panel$state_name=="gujarat" & df_panel$cohort>=1996 & df_panel$cohort<1998]<- 1995
df_panel$election_year[df_panel$state_name=="gujarat" & df_panel$cohort>=1999 & df_panel$cohort<2002]<- 1998
df_panel$election_year[df_panel$state_name=="gujarat" & df_panel$cohort>=2003 & df_panel$cohort<2007]<- 2002
df_panel$election_year[df_panel$state_name=="gujarat" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="gujarat" & df_panel$cohort>=2013]<- 2012

#################### Haryana ###########################

df_panel$election_year[df_panel$state_name=="haryana" & df_panel$cohort>=1992 & df_panel$cohort<1996]<- 1991
df_panel$election_year[df_panel$state_name=="haryana" & df_panel$cohort>=1997 & df_panel$cohort<2000]<- 1996
df_panel$election_year[df_panel$state_name=="haryana" & df_panel$cohort>=2001 & df_panel$cohort<2005]<- 2000
df_panel$election_year[df_panel$state_name=="haryana" & df_panel$cohort>=2006 & df_panel$cohort<2009]<- 2005
df_panel$election_year[df_panel$state_name=="haryana" & df_panel$cohort>=2010 & df_panel$cohort<2014]<- 2009
df_panel$election_year[df_panel$state_name=="haryana" & df_panel$cohort>=2015]<- 2014

########################## Himachal Pradesh ##################

df_panel$election_year[df_panel$state_name=="himachal pradesh" & df_panel$cohort>=1991 & df_panel$cohort<1993]<- 1990
df_panel$election_year[df_panel$state_name=="himachal pradesh" & df_panel$cohort>=1994 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="himachal pradesh" & df_panel$cohort>=1999 & df_panel$cohort<2003]<- 1998
df_panel$election_year[df_panel$state_name=="himachal pradesh" & df_panel$cohort>=2004 & df_panel$cohort<2007]<- 2003
df_panel$election_year[df_panel$state_name=="himachal pradesh" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="himachal pradesh" & df_panel$cohort>=2013]<- 2012

############################# Jammu and Kashmir ####################

df_panel$election_year[df_panel$state_name=="jammu & kashmir" & df_panel$cohort>=1997 & df_panel$cohort<2002]<- 1996
df_panel$election_year[df_panel$state_name=="jammu & kashmir" & df_panel$cohort>=2003 & df_panel$cohort<2008]<- 2002
df_panel$election_year[df_panel$state_name=="jammu & kashmir" & df_panel$cohort>=2009 & df_panel$cohort<2014]<- 2008
df_panel$election_year[df_panel$state_name=="jammu & kashmir" & df_panel$cohort>=2015]<- 2014

##################### Jharkhand ##################################

df_panel$election_year[df_panel$state_name=="jharkhand" & df_panel$cohort>=2006 & df_panel$cohort<2009]<- 2005
df_panel$election_year[df_panel$state_name=="jharkhand" & df_panel$cohort>=2010 & df_panel$cohort<2014]<- 2009
df_panel$election_year[df_panel$state_name=="jharkhand" & df_panel$cohort>2014]<- 2014

################################## Karnataka ###########################

df_panel$election_year[df_panel$state_name=="karnataka" & df_panel$cohort>=1990 & df_panel$cohort<1994]<- 1989
df_panel$election_year[df_panel$state_name=="karnataka" & df_panel$cohort>=1995 & df_panel$cohort<1999]<- 1994
df_panel$election_year[df_panel$state_name=="karnataka" & df_panel$cohort>=2000 & df_panel$cohort<2004]<- 1999
df_panel$election_year[df_panel$state_name=="karnataka" & df_panel$cohort>=2005 & df_panel$cohort<2008]<- 2004
df_panel$election_year[df_panel$state_name=="karnataka" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="karnataka" & df_panel$cohort>=2014]<- 2013

############################## Kerala ##############################

df_panel$election_year[df_panel$state_name=="kerala" & df_panel$cohort>=1992 & df_panel$cohort<1996]<- 1991
df_panel$election_year[df_panel$state_name=="kerala" & df_panel$cohort>=1997 & df_panel$cohort<2001]<- 1996
df_panel$election_year[df_panel$state_name=="kerala" & df_panel$cohort>=2002 & df_panel$cohort<2006]<- 2001
df_panel$election_year[df_panel$state_name=="kerala" & df_panel$cohort>=2007 & df_panel$cohort<2011]<- 2006
df_panel$election_year[df_panel$state_name=="kerala" & df_panel$cohort>=2012 & df_panel$cohort<2016]<- 2011

############################## Madhya Pradesh #######################

df_panel$election_year[df_panel$state_name=="madhya pradesh" & df_panel$cohort>=1991 & df_panel$cohort<1993]<- 1990
df_panel$election_year[df_panel$state_name=="madhya pradesh" & df_panel$cohort>=1994 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="madhya pradesh" & df_panel$cohort>=1999 & df_panel$cohort<2003]<- 1998
df_panel$election_year[df_panel$state_name=="madhya pradesh" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="madhya pradesh" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="madhya pradesh" & df_panel$cohort>=2014]<- 2013

################################ Maharashtra #########################

df_panel$election_year[df_panel$state_name=="maharashtra" & df_panel$cohort>=1991 & df_panel$cohort<1995]<- 1990
df_panel$election_year[df_panel$state_name=="maharashtra" & df_panel$cohort>=1996 & df_panel$cohort<1999]<- 1995
df_panel$election_year[df_panel$state_name=="maharashtra" & df_panel$cohort>=2000 & df_panel$cohort<2004]<- 1999
df_panel$election_year[df_panel$state_name=="maharashtra" & df_panel$cohort>=2005 & df_panel$cohort<2009]<- 2004
df_panel$election_year[df_panel$state_name=="maharashtra" & df_panel$cohort>=2010 & df_panel$cohort<2014]<- 2009
df_panel$election_year[df_panel$state_name=="maharashtra" & df_panel$cohort>=2015]<- 2014


################################ Manipur ##############################

df_panel$election_year[df_panel$state_name=="manipur" & df_panel$cohort>=1991 & df_panel$cohort<1995]<- 1990
df_panel$election_year[df_panel$state_name=="manipur" & df_panel$cohort>=1996 & df_panel$cohort<2000]<- 1995
df_panel$election_year[df_panel$state_name=="manipur" & df_panel$cohort>=2001 & df_panel$cohort<2002]<- 2000
df_panel$election_year[df_panel$state_name=="manipur" & df_panel$cohort>=2003 & df_panel$cohort<2007]<- 2002
df_panel$election_year[df_panel$state_name=="manipur" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="manipur" & df_panel$cohort>2012]<- 2012

########################## Meghalaya ################################

df_panel$election_year[df_panel$state_name=="meghalaya" & df_panel$cohort>=1993 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="meghalaya" & df_panel$cohort>=1999 & df_panel$cohort<2003]<- 1998
df_panel$election_year[df_panel$state_name=="meghalaya" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="meghalaya" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="meghalaya" & df_panel$cohort>=2014]<- 2013

########################## Mizoram ##############################

df_panel$election_year[df_panel$state_name=="mizoram" & df_panel$cohort>=1990 & df_panel$cohort<1993]<- 1989
df_panel$election_year[df_panel$state_name=="mizoram" & df_panel$cohort>=1994 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="mizoram" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="mizoram" & df_panel$cohort>=2014]<- 2013

############################## Nagaland ############################

df_panel$election_year[df_panel$state_name=="nagaland" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="mizoram" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008

################################# Odisha ###########################

df_panel$election_year[df_panel$state_name=="odisha" & df_panel$cohort>=1991 & df_panel$cohort<1995]<- 1990
df_panel$election_year[df_panel$state_name=="odisha" & df_panel$cohort>=1996 & df_panel$cohort<2000]<- 1995
df_panel$election_year[df_panel$state_name=="odisha" & df_panel$cohort>=2001 & df_panel$cohort<2004]<- 2000
df_panel$election_year[df_panel$state_name=="odisha" & df_panel$cohort>=2005 & df_panel$cohort<2009]<- 2004
df_panel$election_year[df_panel$state_name=="odisha" & df_panel$cohort>=2010 & df_panel$cohort<2014]<- 2009
df_panel$election_year[df_panel$state_name=="odisha" & df_panel$cohort>=2015]<- 2014

############################## Punjab ###############################

df_panel$election_year[df_panel$state_name=="punjab" & df_panel$cohort>=1993 & df_panel$cohort<1997]<- 1992
df_panel$election_year[df_panel$state_name=="punjab" & df_panel$cohort>=1998 & df_panel$cohort<2002]<- 1997
df_panel$election_year[df_panel$state_name=="punjab" & df_panel$cohort>=2003 & df_panel$cohort<2007]<- 2002
df_panel$election_year[df_panel$state_name=="punjab" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="punjab" & df_panel$cohort>2013]<- 2012

############################# Rajasthan ###############################

df_panel$election_year[df_panel$state_name=="rajasthan" & df_panel$cohort>=1991 & df_panel$cohort<1993]<- 1990
df_panel$election_year[df_panel$state_name=="rajasthan" & df_panel$cohort>=1994 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="rajasthan" & df_panel$cohort>=1999 & df_panel$cohort<2003]<- 1998
df_panel$election_year[df_panel$state_name=="rajasthan" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="rajasthan" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="rajasthan" & df_panel$cohort>2014]<- 2013

################################# Tamil Nadu ##########################

df_panel$election_year[df_panel$state_name=="tamil nadu" & df_panel$cohort>=1992 & df_panel$cohort<1996]<- 1991
df_panel$election_year[df_panel$state_name=="tamil nadu" & df_panel$cohort>=1997 & df_panel$cohort<2001]<- 1996
df_panel$election_year[df_panel$state_name=="tamil nadu" & df_panel$cohort>=2002 & df_panel$cohort<2006]<- 2001
df_panel$election_year[df_panel$state_name=="tamil nadu" & df_panel$cohort>=2007 & df_panel$cohort<2011]<- 2006
df_panel$election_year[df_panel$state_name=="tamil nadu" & df_panel$cohort>=2012 & df_panel$cohort<2016]<- 2011

################################### Tripura #######################

df_panel$election_year[df_panel$state_name=="tripura" & df_panel$cohort>=1994 & df_panel$cohort<1998]<- 1993
df_panel$election_year[df_panel$state_name=="tripura" & df_panel$cohort>=1999 & df_panel$cohort<2003]<- 1998
df_panel$election_year[df_panel$state_name=="tripura" & df_panel$cohort>=2004 & df_panel$cohort<2008]<- 2003
df_panel$election_year[df_panel$state_name=="tripura" & df_panel$cohort>=2009 & df_panel$cohort<2013]<- 2008
df_panel$election_year[df_panel$state_name=="tripura" & df_panel$cohort>=2014]<- 2013

################################ Uttar Pradesh ##########################

df_panel$election_year[df_panel$state_name=="uttar pradesh" & df_panel$cohort>=1992 & df_panel$cohort<1993]<- 1991
df_panel$election_year[df_panel$state_name=="uttar pradesh" & df_panel$cohort>=1994 & df_panel$cohort<1996]<- 1993
df_panel$election_year[df_panel$state_name=="uttar pradesh" & df_panel$cohort>=1997 & df_panel$cohort<2002]<- 1996
df_panel$election_year[df_panel$state_name=="uttar pradesh" & df_panel$cohort>=2003 & df_panel$cohort<2007]<- 2002
df_panel$election_year[df_panel$state_name=="uttar pradesh" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="uttar pradesh" & df_panel$cohort>=2013]<- 2012

##################### Uttarakhand ##################################

df_panel$election_year[df_panel$state_name=="uttarakhand" & df_panel$cohort>=2003 & df_panel$cohort<2007]<- 2002
df_panel$election_year[df_panel$state_name=="uttarakhand" & df_panel$cohort>=2008 & df_panel$cohort<2012]<- 2007
df_panel$election_year[df_panel$state_name=="uttarakhand" & df_panel$cohort>2012]<- 2012

############################### West Bengal #############################

df_panel$election_year[df_panel$state_name=="west bengal" & df_panel$cohort>=1991 & df_panel$cohort<1996]<- 1991
df_panel$election_year[df_panel$state_name=="west bengal" & df_panel$cohort>=1997 & df_panel$cohort<2001]<- 1996
df_panel$election_year[df_panel$state_name=="west bengal" & df_panel$cohort>=2002 & df_panel$cohort<2006]<- 2001
df_panel$election_year[df_panel$state_name=="west bengal" & df_panel$cohort>=2007 & df_panel$cohort<2011]<- 2006
df_panel$election_year[df_panel$state_name=="west bengal" & df_panel$cohort>=2012 & df_panel$cohort<2016]<- 2011

######################### Removing observations recorded on election years ##########################
...
write.csv(df_panel,"NFHS_all_birth_orders.csv")
...
write.csv(df_first_second,"NFHS_1_2_birth_orders.csv")
...
write.csv(df_first_third,"NFHS_1_3_birth_orders.csv")
...
write.csv(df_second_third,"NFHS_2_3_birth_orders.csv")